...
def trainer():
    ...
    eval_freq = 1
    save_freq = 1
    exp_name = f'places/patch_transformer/w_cls_{w_cls:.2f}_w_patch_{w_patch:.2f}'
    ...
    train_dataset = Places365('/home/shuqin/hdd/datasets/places365', 'train-standard', small=True, download=True, transform=train_transform)
    ...
    val_dataset = Places365('/home/shuqin/hdd/datasets/places365', 'val', small=True, download=True, transform=val_transform)
    val_loader = DataLoader(val_dataset, batch_size=bs, num_workers=4, shuffle=False, pin_memory=True)

    transformer = patch_vit_small_patch16_224(365, 1000, pretrained=True).cuda()
